<div class="relative mt-10">
    <div class="">
        <div>
            <form action="" class="flex flex-col w- h-auto">
                <div>
                ...
                <div class="w-1/2">
                    ...
                    <select name="" id="" class="text-gray-900 w-full p-1">
                        <option value="" class="p-1">No repeat</option>
                        <option value="" class="p-1">Once a day</option>
                        <option value="" class="p-1">Once a day (Mon - Fri)</option>
                        <option value="" class="p-1">Once a week</option>
                        <option value="" class="p-1">Once a month</option>
                        <option value="" class="p-1">Other</option>
                    </select>
                </div><br>
                <div class="w-1/2">
                    <h3>Add to list</h3>
